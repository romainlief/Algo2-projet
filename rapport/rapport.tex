...
\begin{itemize}
    ...
    \item \textbf{Limited walking:} Une troisième optimisation que nous avons implémenté est la limitation du nombre et des distances des transferts à pied. 
...
Nous avons également considéré d'ajouter des paramètres à notre implémentation de l'algorithme de sorte à ce que les connexions soient filtrées avant d'être traitées directement
durant l'exécution. Cette option nous paraissait pertinente et réalisable mais, par manque de temps, nous n'avons pas eu l'occasion d'essayer de l'implémenter.

\section{Conclusion}
Ce projet nous a mené vers la découverte de nombreux concepts intéressants comme la recherche de voisins les plus proches à l'aide de différentes structures de données ainsi que
...
et de recherches annexes, nous nous somme rendus compte de certains défauts. Comme expliqué dans la secion précédente, malgré sa facilité d'implémentation, il ne répond 
