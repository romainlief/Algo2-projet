...
Cette structure permet de récupérer efficacement les voisins d'un arrêt donné dans un rayon donné à l'aide de requêtes rapides.
...
Nous avons également envisagé l'ajout de paramètres à notre implémentation de l'algorithme de sorte que les connexions soient filtrées avant d'être traitées directement
